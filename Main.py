...
#Essential Variable list:
#Ready, dead, won, restart.

ready = input("Are you ready? Please type Yes If you are. ")
if ready == ("Yes"):
  bedroomtodownstairs = input("One night, you are chilling in your bedroom when you hear a strange noise from downstairs, you wonder if you should go. Yes Or No? ") 
  if bedroomtodownstairs == ("Yes"):
    hidedownstairs1 = input("You creep downstairs making sure that that you don't make any noise on the steps. And suddenly you see movement. What do you do? Hide or Continue looking? ")
    if hidedownstairs1 == ("Hide"):
      lookorhideclosethiding1 = input("You decide to hide in the closet and go all the way to the back to hide behind a thick layer of coats. You hear footsteps going towards your direction, you hope that they are just walking to the kitchen as it is right next to you. But you arent sure. Do you Continue hiding or do you try to Take a look? ")
...
#######################################################
# Release 1.1 ---- Credits: github.com/WhineyMonkey10 #
#######################################################
